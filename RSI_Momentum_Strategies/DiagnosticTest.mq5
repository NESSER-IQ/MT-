...
//| Version: 1.0                                                     |
//| Description: Comprehensive diagnostic tool to verify system     |
//|              integrity and troubleshoot common issues           |
//+------------------------------------------------------------------+

#property copyright "RSI Momentum Strategies"
#property version   "1.00"
#property description "System diagnostic and health check tool"
...
void OnStart()
{
    ...
    // Safe terminal build info using available MQL5 constants
    ResetLastError();
    #ifdef __MQL5BUILD__
...
void GenerateTestReport()
{
    ...
    if(file_handle != INVALID_HANDLE)
    {
        ...
        // Safe terminal build info for report using available constants
        ResetLastError();
        #ifdef __MQL5BUILD__
            int report_terminal_build = __MQL5BUILD__;
        #else
            int report_terminal_build = 2024; // Default version if not available
        #endif
        FileWriteString(file_handle, "<p><strong>Terminal Build:</strong> " + IntegerToString(report_terminal_build) + "</p>");
        FileWriteString(file_handle, "<p><strong>MQL5 Version:</strong> v1.0</p>");
        ...
        FileWriteString(file_handle, "Generated by RSI Momentum Strategies Diagnostic Tool v1.0<br>");
